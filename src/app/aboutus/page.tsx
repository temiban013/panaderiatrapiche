  ...
  return (
    <Layout>
      ...
      <div className="snap-x snap-mandatory snap-align-start snap-justify-start overflow-x-auto">
        ...
        <Image className="snap-center shrink-0" alt='Dish 1' src="https://res.cloudinary.com/drc0myo7z/image/upload/c_scale,w_1080/v1699472788/Trapiche/Menus/About_US_2_syrgf3.jpg" width={1500} height={533} />
        <div className="absolute top-5 right-2 lg:right-32 md:right-16">
          ...
          <div className="absolute top-6 lg:top-20 md:top-20 right-0 w-16 md:w-40 lg:w-48">
            <Image className='w-full h-auto' src="https://res.cloudinary.com/drc0myo7z/image/upload/c_scale,w_256/v1697420759/Trapiche/logos/Logos-Trapiche-Bakery-1-_1__yg7wqm.gif" alt="Logo" width={500} height={500} />
          </div>
        </div>
