  ...
  return (
    <>
      <div className="snap-x snap-mandatory snap-align-start snap-justify-start overflow-x-auto bg-trapiche-orange">
          ...
          <Image className="snap-center shrink-0" alt='Menu 1' src="https://res.cloudinary.com/drc0myo7z/image/upload/c_scale,w_1080/v1702497899/Trapiche/Menus/Trapiche_web_1_mdpcmf.jpg" width={2000} height={533} />
          ...
          <Image className="snap-center shrink-0" alt='Menu 2' src="https://res.cloudinary.com/drc0myo7z/image/upload/c_scale,w_1080/v1702497905/Trapiche/Menus/Trapiche_web_2_c0wxs0.jpg" width={2000} height={533} />
          ...
          <Image className="snap-center shrink-0" alt='Menu 3' src="https://res.cloudinary.com/drc0myo7z/image/upload/c_scale,w_1080/v1702497905/Trapiche/Menus/Trapiche_web_3_fiqgqd.jpg" width={2000} height={533} />
          ...
          <Image className="snap-center shrink-0" alt='Menu 4' src="https://res.cloudinary.com/drc0myo7z/image/upload/c_scale,w_1080/v1702497908/Trapiche/Menus/Trapiche_web_4_dtijvp.jpg" width={2000} height={533} />
          ...
          <Image className="snap-center shrink-0" alt='Menu 5' src="https://res.cloudinary.com/drc0myo7z/image/upload/c_scale,w_1080/v1702497905/Trapiche/Menus/Trapiche_Web_5_zdbyl4.jpg" width={2000} height={533} />
          ...
          <Image className="snap-center shrink-0" alt='Menu 6' src="https://res.cloudinary.com/drc0myo7z/image/upload/c_scale,w_1080/v1702497904/Trapiche/Menus/Trapiche_web_6_celnpe.jpg" width={2000} height={533} />
          ...
          <Image className="snap-center shrink-0" alt='Menu 7' src="https://res.cloudinary.com/drc0myo7z/image/upload/c_scale,w_1080/v1702497908/Trapiche/Menus/Trapiche_web_7_ejyjla.jpg" width={2000} height={533} />
