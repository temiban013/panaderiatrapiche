  ...
  return (
    <>
      <div className="snap-x snap-mandatory snap-align-start snap-justify-start overflow-x-auto bg-trapiche-orange">
          ...
          <Image className="snap-center shrink-0" alt='Menu 3' src="https://res.cloudinary.com/drc0myo7z/image/upload/c_scale,w_1080/v1702497905/Trapiche/Menus/Trapiche_web_3_fiqgqd.jpg?v=1" width={2000} height={533} />
          ...
          <Image className="snap-center shrink-0" alt='Menu 7' src="https://res.cloudinary.com/drc0myo7z/image/upload/c_scale,w_1080/v1702497908/Trapiche/Menus/Trapiche_web_7_ejyjla.jpg?v=1" width={2000} height={533} />
